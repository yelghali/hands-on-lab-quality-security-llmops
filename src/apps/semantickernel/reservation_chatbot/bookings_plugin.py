...
class BookingsPlugin:
    ...
    @kernel_function(name="return_meteo", description="Returns meteo / weather forecast")
    async def return_meteo(self) -> Annotated[str, "The meteo message"]:
        """return Hello
